...
contract ERC1643 is IERC1643 {
     ...
     */
    function getDocument(bytes32 _name) override external view returns (string memory, bytes32, uint256) {
        return (
     ...
     */
    function getAllDocuments() override external view returns (bytes32[] memory) {
        return _docNames;
    }
