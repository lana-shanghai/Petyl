...
contract CertificateControllerMock {
    ...
    function _initCertificateController (address _certificateSigner) internal {
    ...
    modifier isValidCertificate(bytes memory data) {
        // remove msg.value to compile
        // TODO: determine what to pass as value to _checkCertificateMock, use 0 for testing only
        require(_checkCertificateMock(data, 0, 0x00000000), "A3: Transfer Blocked - Sender lockup period not ended");
     ...
     */
    function _checkCertificateMock(
        bytes memory data,
        uint256 /*value*/,
        bytes4 /*functionID*/
    )
